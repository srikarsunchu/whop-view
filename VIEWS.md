...
**Not yet.** One tool per recipe with a typed input schema. The skills as MCP prompts and resources. The eval runner in MCP mode. These are the next steps, in that order.
